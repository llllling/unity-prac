...
* 오디오 소스 컴포넌트[https://www.notion.so/10b5505bc7ca4e3cb498954d3faf0606] : 게임 오브젝트에 소리를 낼 수 있는 능력을 부여
...
* 애니메이터 컨트롤러와 애니메이터 컴포넌트[https://www.notion.so/Animation-0c53a802528443538eb41ec3be164b11]
...
* 블렌드 트리 : 애니메이터의 상태에는 애니메이션 클립이 할당되는 데 평범한 애니메이션 클립이 아닌 특수한 종류의 모션(움직임을 나타내는 에셋)을 상태에 할당하는 것도 가능함. 그중 하나가 **애니메이션 클립을 혼합하는 블렌드 트리모션**이다.
  ...
  * 자세한 설명은 https://www.notion.so/Animation-Layer-Blend-82b368511e1640038c7d93cb9a6ca1b7 블렌드 트리 섹션에 정리함.
